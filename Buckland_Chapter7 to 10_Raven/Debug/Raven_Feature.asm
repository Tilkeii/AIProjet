; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	C:\Users\Usager\Documents\AIProjet\Buckland_Chapter7 to 10_Raven\goals\Raven_Feature.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG172289 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
$SG172291 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG172293 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG172297 DB	'trying to calculate  of unknown weapon', 00H
	ORG $+1
_colors	DD	0ffH
	DD	0ff0000H
	DD	0ff00H
...
PUBLIC	??_C@_1GO@CMMEIBPG@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAU?$AAs?$AAa?$AAg?$AAe?$AAr?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAA?$AAI?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1GO@CMMEIBPG@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAU?$AAs?$AAa?$AAg?$AAe?$AAr?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAA?$AAI?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1GO@CMMEIBPG@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAU?$AAs?$AAa?$AAg?$AAe?$AAr?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAA?$AAI?$AAP?$AAr?$AAo?$AAj@ DB 'C'
	...
	DB	'/', 00H, 'u', 00H, 't', 00H, 'i', 00H, 'l', 00H, 's', 00H, '.'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\documents\aiprojet\buckland_chapter7 to 10_raven\goals\raven_feature.cpp
_TEXT	SEGMENT
tv64 = -16						; size = 4
$T1 = -12						; size = 12
...
$LN5@Clamp:
	push	175					; 000000afH
	push	OFFSET ??_C@_1GO@CMMEIBPG@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAU?$AAs?$AAa?$AAg?$AAe?$AAr?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAA?$AAI?$AAP?$AAr?$AAo?$AAj@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\documents\aiprojet\buckland_chapter7 to 10_raven\armory\raven_weapon.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\documents\aiprojet\common\lua-5.1.3\include\luahelperfunctions.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\documents\aiprojet\common\script\scriptor.h
