; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	C:\Users\Usager\Downloads\AIMiniProjet\Buckland_Chapter7 to 10_Raven\triggers\Trigger_HealthGiver.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1IG@IDLLOBJI@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1IG@IDLLOBJI@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
CONST	SEGMENT
??_C@_1IG@IDLLOBJI@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'C'
...
; 520  : 			_DEBUG_ERROR("istreambuf_iterator is not incrementable");
	...
	push	520					; 00000208H
	push	OFFSET ??_C@_1IG@IDLLOBJI@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\common\misc\stream_utility_functions.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\common\lua-5.1.3\include\luahelperfunctions.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\common\script\scriptor.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\buckland_chapter7 to 10_raven\triggers\trigger_healthgiver.cpp
_TEXT	SEGMENT
tv248 = -128						; size = 8
tv246 = -120						; size = 4
tv243 = -114						; size = 2
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\common\triggers\trigger_respawning.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\common\triggers\trigger.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\common\triggers\triggerregion.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\downloads\aiminiprojet\common\game\basegameentity.h
