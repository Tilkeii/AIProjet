; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.50727.1 
	...
	TITLE	C:\Users\Flo\Desktop\AIProjet\Buckland_Chapter7 to 10_Raven\Goal_DodgeGetItem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Activate@Goal_DodgeGetItem@@UAEXXZ		; Goal_DodgeGetItem::Activate
PUBLIC	?Process@Goal_DodgeGetItem@@UAEHXZ		; Goal_DodgeGetItem::Process
PUBLIC	?Render@Goal_DodgeGetItem@@UAEXXZ		; Goal_DodgeGetItem::Render
PUBLIC	?Terminate@Goal_DodgeGetItem@@UAEXXZ		; Goal_DodgeGetItem::Terminate
...
EXTRN	?canStepDiagonalGauche@Raven_Bot@@QBE_NAAUVector2D@@@Z:PROC ; Raven_Bot::canStepDiagonalGauche
EXTRN	?canStepDiagonaleDroite@Raven_Bot@@QBE_NAAUVector2D@@@Z:PROC ; Raven_Bot::canStepDiagonaleDroite
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\flo\desktop\aiprojet\buckland_chapter7 to 10_raven\goal_dodgegetitem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Terminate@Goal_DodgeGetItem@@UAEXXZ PROC		; Goal_DodgeGetItem::Terminate
; _this$ = ecx
...
; 94   :   m_pOwner->GetSteering()->SeekOff();
...
; 95   : }
	...
	pop	ebp
	ret	0
?Terminate@Goal_DodgeGetItem@@UAEXXZ ENDP		; Goal_DodgeGetItem::Terminate
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\flo\desktop\aiprojet\buckland_chapter7 to 10_raven\goal_dodgegetitem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Render@Goal_DodgeGetItem@@UAEXXZ PROC			; Goal_DodgeGetItem::Render
; _this$ = ecx
...
; 101  : //#define SHOW_TARGET
; 102  : #ifdef SHOW_TARGET
; 103  :   gdi->OrangePen();
; 104  :   gdi->HollowBrush();
; 105  : 
; 106  :   gdi->Line(m_pOwner->Pos(), m_vStrafeTarget);
; 107  :   gdi->Circle(m_vStrafeTarget, 3);
; 108  : #endif
; 109  :   
; 110  : }
	...
	pop	ebp
	ret	0
?Render@Goal_DodgeGetItem@@UAEXXZ ENDP			; Goal_DodgeGetItem::Render
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\flo\desktop\aiprojet\buckland_chapter7 to 10_raven\goal_dodgegetitem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Process@Goal_DodgeGetItem@@UAEHXZ PROC			; Goal_DodgeGetItem::Process
; _this$ = ecx
...
; 67   :   //if status is inactive, call Activate()
; 68   :   ActivateIfInactive(); 

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ ; Goal<Raven_Bot>::ActivateIfInactive

; 69   : 
; 70   :   //if target goes out of view terminate
; 71   :   if (!m_pOwner->GetTargetSys()->isTargetWithinFOV())
...
; 74   :   }
; 75   : 
; 76   :   //else if bot reaches the target position set status to inactive so the goal 
; 77   :   //is reactivated on the next update-step
; 78   :   else if (m_pOwner->isAtPosition(m_vStrafeTarget))
...
; 88   : }
	...
	pop	ebp
	ret	0
?Process@Goal_DodgeGetItem@@UAEHXZ ENDP			; Goal_DodgeGetItem::Process
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\flo\desktop\aiprojet\buckland_chapter7 to 10_raven\goal_dodgegetitem.cpp
_TEXT	SEGMENT
...
tv137 = -8						; size = 4
_this$ = -4						; size = 4
?Activate@Goal_DodgeGetItem@@UAEXXZ PROC		; Goal_DodgeGetItem::Activate
; _this$ = ecx
...
; 24   :     {
; 25   : 	  if (m_pOwner->canStepDiagonaleDroite(m_vStrafeTarget))
	...
	call	?canStepDiagonaleDroite@Raven_Bot@@QBE_NAAUVector2D@@@Z ; Raven_Bot::canStepDiagonaleDroite
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN5@Activate

; 26   :       {
; 27   : 		  // Faire fonction diagonale droite et gauche
...
; 29   : 		  /*if(m_pOwner->canStepBackward(m_vStrafeTarget)){
...
; 34   :       {
; 35   :         //debug_con << "changing" << "";
; 36   :         m_bClockwise = !m_bClockwise;
...
; 42   :     {
; 43   : 	  if (m_pOwner->canStepDiagonalGauche(m_vStrafeTarget))
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?canStepDiagonalGauche@Raven_Bot@@QBE_NAAUVector2D@@@Z ; Raven_Bot::canStepDiagonalGauche
	movzx	ecx, al
	test	ecx, ecx
...
; 46   : 		/*if(m_pOwner->canStepBackward(m_vStrafeTarget)){
; 47   : 			m_pOwner->GetSteering()->SetTarget(m_vStrafeTarget);
; 48   : 		}*/
; 49   :       }
; 50   :       else
...
; 51   :       {
; 52   :        // debug_con << "changing" << "";
; 53   :         m_bClockwise = !m_bClockwise;
...
; 59   : }
	...
	pop	ebp
	ret	0
?Activate@Goal_DodgeGetItem@@UAEXXZ ENDP		; Goal_DodgeGetItem::Activate
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
