; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61219.0 
	...
	TITLE	C:\Users\Usager\Desktop\AIProjet\Buckland_Chapter7 to 10_Raven\Goal_DodgeGetItem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
EXTRN	?canStepBackward@Raven_Bot@@QBE_NAAUVector2D@@@Z:PROC ; Raven_Bot::canStepBackward
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\desktop\aiprojet\buckland_chapter7 to 10_raven\raven_steeringbehaviors.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\desktop\aiprojet\buckland_chapter7 to 10_raven\goal_dodgegetitem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 93   :   m_pOwner->GetSteering()->SeekOff();
...
; 100  : //#define SHOW_TARGET
; 101  : #ifdef SHOW_TARGET
; 102  :   gdi->OrangePen();
; 103  :   gdi->HollowBrush();
; 104  : 
; 105  :   gdi->Line(m_pOwner->Pos(), m_vStrafeTarget);
; 106  :   gdi->Circle(m_vStrafeTarget, 3);
; 107  : #endif
; 108  :   
; 109  : }
...
; 66   :   //if status is inactive, call Activate()
...
; 68   : 
; 69   :   //if target goes out of view terminate
; 70   :   if (!m_pOwner->GetTargetSys()->isTargetWithinFOV())
...
; 73   :   }
; 74   : 
; 75   :   //else if bot reaches the target position set status to inactive so the goal 
; 76   :   //is reactivated on the next update-step
; 77   :   else if (m_pOwner->isAtPosition(m_vStrafeTarget))
...
; 28   : 		  if(m_pOwner->canStepBackward(m_vStrafeTarget)){
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?canStepBackward@Raven_Bot@@QBE_NAAUVector2D@@@Z ; Raven_Bot::canStepBackward
	movzx	edx, al
	test	edx, edx
	je	SHORT $LN6@Activate

; 29   : 			m_pOwner->GetSteering()->SetTarget(m_vStrafeTarget);
...
; 41   :     {
; 42   :       if (m_pOwner->canStepLeft(m_vStrafeTarget))
...
; 43   :       {
; 44   : 		  m_pOwner->GetSteering()->SetTarget(m_vStrafeTarget);
...
; 45   : 		if(m_pOwner->canStepBackward(m_vStrafeTarget)){
...
; 46   : 			m_pOwner->GetSteering()->SetTarget(m_vStrafeTarget);
...
; 50   :       {
; 51   :        // debug_con << "changing" << "";
; 52   :         m_bClockwise = !m_bClockwise;

	mov	edx, DWORD PTR _this$[ebp]
	movzx	eax, BYTE PTR [edx+32]
	test	eax, eax
	jne	SHORT $LN13@Activate
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\usager\desktop\aiprojet\common\goals\goal.h
